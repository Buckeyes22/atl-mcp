...
| Storage repositories | `tests/integration/storage/repositories.test.ts` | All 15 tables — CRUD + queries |
...
| Role workflow admin tools | `tests/integration/admin/roleWorkflowTools.test.ts` | Requirements Assist, agent recommendation/assignment, content quality scoring |
