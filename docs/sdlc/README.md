...
> **TL;DR:** This is the entry point for atl-mcp's enterprise SDLC documentation. The 17 numbered subdirectories cover every phase of the software lifecycle: charter through cost. If you're an auditor, on-call engineer, integrator, or new team member, start here. If you're looking for the *spec* (what to build), see [`agent-context-orchestrator-mcp-plan-v6.md`](../../agent-context-orchestrator-mcp-plan-v6.md). If you're looking for the *demo portfolio*, see [`docs/demo/`](../demo/). For the **visualization companion site** (18 SVG figures plus an index), open [`docs/visualizations/index.html`](../visualizations/index.html).
...
| How do role-specific UI workflows work? | [`04-design/control-plane-ui/role-workflows.md`](04-design/control-plane-ui/role-workflows.md) |
...
- [`README.md`](04-design/README.md) — Design documentation index
...
- [`module-agent-memory.md`](04-design/module-agent-memory.md) — Project-scoped persistent agent memory
...
- [`control-plane-ui/README.md`](04-design/control-plane-ui/README.md) — Operator UI route map, data provenance, UX system, page catalog, and governance
- [`control-plane-ui/role-workflows.md`](04-design/control-plane-ui/role-workflows.md) — Role lens, Requirements Assist, agent assignment, content quality scoring, and agent role catalog design

### `05-data/` — What does it persist?

Schema, domain model, retention, classification, migrations.

- [`schema.md`](05-data/schema.md) — 15 tables × ER diagram
- [`domain-model.md`](05-data/domain-model.md) — 23 root domain types plus supporting subtypes
...
This tree was authored as a comprehensive SDLC documentation pass on 2026-04-25, extended with operator control plane design documentation on 2026-04-26, and updated on 2026-04-27 for role-specific control-plane workflows, Requirements Assist, developer agent assignment, content quality scoring, and packed responsive UI behavior. It now contains 100+ files across 17 categories. All Phase A (foundation) docs are accepted. Phases B-D land per the plan in [`C:\Users\Chris\.claude\plans\generate-a-comprehensive-plan-wobbly-scroll.md`](../../../.claude/plans/generate-a-comprehensive-plan-wobbly-scroll.md).
